---
title: "POLS 3000: Principles of Programming"
subtitle: "Getting Started with R, R Studio, Git, and Github"
author: "Professor Knuppe"
...
**NOTE**: R and RStudio *cannot be installed* on a tablet (e.g., iPad or Microsoft Surface), and is *difficult to install and operation* on a web-centric laptop (e.g., Google Chromebook). If your rely on either platform, I would suggest completing course work in a computer lab on campus. Both the [Taggart Student Center (TSC) Computer Lab](https://it.usu.edu/labs/computer-labs/tsc) and [Ag Science Computer](https://it.usu.edu/labs/computer-labs/ag-science) Lab have R and RStudio installed.  

To begin, we're going to get R, RStudio, and R Markdown set up on your computer. To get started, follow these steps: 
...
2. With R installed, download and install [RStudio][]. RStudio is a type of "integrated development environment" (IDE) that makes working with R considerably easier. RStudio is available for free on Mac, Windows, and Linux operating systems.
...
![](images/github-pat.png){fig-alt="Create a GitHub PAT"}
...
![](images/github-pat-copy.png){fig-alt="Copy the GitHub PAT"}
...
![](images/github-create-new.png){fig-alt="Create a new repo"}
...
![](images/github-create-options.png){fig-alt="New Repo Options"}
...
![](images/github-clone.png){fig-alt="Cloning the repo"}

Now, switch to RStudio. Go to the menu bar and hit "File > New Project". You can then choose what type of project to start. Since we're importing from Github, we'll use the "Version Control" option (it's at the bottom of the list). In the next menu, choose "Git". Now, you can paste the URL in the "Repository URL" box. Choose a set of local directories to place this project and hit "Create Project". And now you'll have your project ready to go in RStudio.
...
![](images/rstudio-files.png){fig-alt="Files in RStudio"}
...
![](images/rstudio-git-panel.png){fig-alt="Git panel in RStudio"}
...
![](images/rstudio-edit-gitignore.png){fig-alt="Editing .gitignore"}
...
![](images/rstudio-commit.png){fig-alt="Commit dialog box in RStudio"}
...
![](images/rstudio-push.png){fig-alt="Push to GitHub"}
...
![](images/github-changed.png){fig-alt="Github repo after commit"}
